...
class Score():
    ...
    def image_score(self):
        # преобразывает текст счета в графическое извображение
        self.score_img = self.font.render(
            str(self.stats.score), True, self.text_color, (0, 0, 0))
        self.score_rect = self.score_img.get_rect()
        self.score_rect.right = self.screen_rect.right - 40  # в видео 40
        self.score_rect.top = 20

    def image_high_score(self):
        # приобразует рекорд в графическое изображение
